...
public class TestHangThucPham {
	public static void main(String[] args) throws Exception {
		...
		HangThucPham htp3 = new HangThucPham("003", "Nuoc", 10000, LocalDate.of(2018, 3, 1), LocalDate.of(2019, 3, 1));

		System.out.println(String.format("%-10s %-20s %-10s %-10s %-10s %-10s", "Ma hang", "Ten hang", "Don gia",
